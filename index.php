...
<body>
  ...
  <div class="login-wrap">
	<div class="login-html">
		...
		<div id="text_holder">
			<h2><span style="color:rgba(255, 152, 0, 0.91);text-align:center;font-family:sans">tusolutionweb <br><br>ADMINISTRACION DEL SISTEMA visite http://tusolutionweb.blogspot.pe/</span></h2>
		</div>
      ...
      <form method="post" action="">
			<div class="sign-in-htm">
				...
				<div class="group" style="text-align: center">
					<a href="admin/index.php"><u style="color:#26e2f7">Administrador</u></a>
				</div>
      ...
      <form method="post" action="">
        ...
        <div class="group">
          <label for="index_number" class="label">Número de índice</label>
